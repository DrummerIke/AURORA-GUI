...
def phone_worker(job_id: str, phone: str, claimed_name: str = "", purpose: str = "authorized_osint_check", consent: bool = False) -> None:
    ...
    try:
        ...
        case = run_pipeline_sync(phone, job_id, claimed_name=claimed_name, purpose=purpose, consent=consent)
