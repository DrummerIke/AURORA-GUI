...
import argparse, os, importlib.util, shutil, socket, sys
...
def parse_args():
    parser=argparse.ArgumentParser(description="Проверка готовности AURORA")
    parser.add_argument("--connectors-only",action="store_true",help="не проверять PostgreSQL, Redis и общий сетевой probe")
